...
const Button = ({ type, text }) => {
    if (type === 'primary') {
        return <button className='bg-gradient-green text-xl rounded-md w-[330px] md:w-[390px] lg:w-[430px] py-3 text-white font-semibold cursor-pointer border-1 border-transparent hover:border-dark-green hover:bg-gradient-white hover:text-black transition-colors duration-150'>{text}</button>
    } else if (type === 'gost') {
