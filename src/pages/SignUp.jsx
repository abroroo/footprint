                ...
                <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                    ...
                    <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                        <div className="max-w-md mx-auto">
                            <div>
                                <h1 className="text-2xl font-semibold">Sign up with your Password and Email</h1>
                            </div>
                            <div className="divide-y divide-slate-200">
                                <div className="py-8 text-base leading-6 space-y-4 text-slate-700 sm:text-lg sm:leading-7">
                                    ...
                                    <div className="relative">
                                        <Link to='/'>
                                            <button className="bg-dark-green text-white rounded-md px-2 py-1">Sign Up</button>
                                        </Link>
                                    </div>
                                </div>
                            </div>
